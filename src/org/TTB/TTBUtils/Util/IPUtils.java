...
{ 
    ...
    public static String ipToTime(String ip)
    {
        ...
        {
            String url = "[url]http://api.ipinfodb.com/v3/ip-city/?key=d7859a91e5346872d0378a2674821fbd60bc07ed63684c3286c083198f024138&ip="+ip+"&format=json";
    ...
    public static String getWeather(String ip)
    {
        ...
        String search = getCityName(ip)+","+getCountryCode(ip);
        String url = "[url]http://api.openweathermap.org/data/2.5/weather?q=[/url]"+search;
